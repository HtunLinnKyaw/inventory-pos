                ...
                <div class="box-body">
                      ...
                      <div class="col-md-6">
                          ...
                          <div class="form-group">
                              ...
                              <input type="number" min="1" step="1" class="form-control" name="txtsaleprice" value="<?php echo $saleprice; ?>" placeholder="Enter ..." required>
                          </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input type="file" class="input-group" name="myfile" value="" required>
                              <p>upload image</p>
                          </div>
