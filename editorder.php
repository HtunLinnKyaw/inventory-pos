...
$row = $select->fetch(PDO::FETCH_ASSOC);
    ...
    // tbl_invoice_details query start
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="txtcustomer" value="<?php echo $customer_name; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                            ...
                            <table id="producttable" class="table table-striped">
                                ...
                                ?>
                                    <tr>
                                       ...
                                       echo ' <td><input type="number" min="0" class="form-control qty" name="qty[]" value="'.$item_invoice_details['qty'].'" required></td>';
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','.btnadd',function(){
            ...
            html+=' <td><select class="form-control  productid" name="productid[]" style="width: 100%;"><option value="">Select Option</option><?php echo fill_product($pdo,''); ?></select></td>';
            html+=' <td><input type="text" class="form-control stock" name="stock[]" readonly></td>';
            html+=' <td><input type="text" class="form-control price" name="price[]" readonly></td>';
            html+=' <td><input type="number" min="0" class="form-control qty" name="qty[]" required></td>';
        ...
        $("#producttable").delegate(".qty","keyup change",function(){
            ...
            if( (quantity.val()-0) > (tr.find(".stock").val()-0) ){
                swal.fire("WARNING!","SORRYk! This much of quantity is not available","warning");
