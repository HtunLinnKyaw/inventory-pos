...
// set font to arial,bold and 16pt
$pdf->SetFont('Arial','B',16);

// Cell(width,height,text,border,end line,[align])
$pdf->Cell(80,10,'NITRO   INC',0,0,'');
...
$pdf->SetFont('Arial','',8);
$pdf->Cell(80,5,'E-mail Address : mario@mail.com',0,1,'');
$pdf->Cell(80,5,'Website : www.nitro.com',0,1,'');
...
$pdf->Cell(100,8,'Ryzen 9 5900X',1,0,'L'); // 190
$pdf->Cell(20,8,'1',1,0,'C');
$pdf->Cell(30,8,'2000',1,0,'C');
$pdf->Cell(40,8,'2000',1,1,'C');

$pdf->SetFont('Arial','B',12);

$pdf->Cell(100,8,'RTX 3090 Asus Tuf Gaming',1,0,'L'); // 190
$pdf->Cell(20,8,'1',1,0,'C');
...
$pdf->Cell(100,8,'Cooler Master NR200P ITX Case',1,0,'L'); // 190
$pdf->Cell(20,8,'1',1,0,'C');
